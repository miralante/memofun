---
tema: "Itinerario Personal para la Empleabilidad II - FP GM Gestión Administrativa (2º)"
nivel: "avanzado"
cantidad: 45
salida: "fpgm_ga_2_itinerario-personal-empleabilidad-2.json"
---
# Índice
- RA1 — Las técnicas avanzadas de búsqueda de empleo
- RA1 — La entrevista de trabajo: preparación y desarrollo
- RA1 — Las pruebas de selección y las dinámicas de grupo
- RA1 — El seguimiento de candidaturas y la mejora continua
- RA2 — La adaptación al cambio en el entorno laboral
- RA2 — La negociación en el trabajo
- RA2 — La igualdad de género en el ámbito laboral
- RA2 — La ética profesional
- RA2 — La prevención de riesgos laborales en el sector administrativo
- RA3 — El proyecto profesional propio
- RA3 — El autoempleo y el emprendimiento
- RA3 — La idea de negocio y su viabilidad
- RA3 — El plan de empresa sencillo
- RA3 — Las estrategias de marketing para el proyecto emprendedor
- RA3 — La financiación del proyecto emprendedor
...
Administrativa". Módulo profesional 1710, de carácter **transversal**
y común a todos los títulos de FP de grado medio (Ley Orgánica 3/2022).
Continúa "Itinerario personal para la empleabilidad I" de 1º, con más
peso en el emprendimiento y el proyecto profesional propio, de cara a
la incorporación al mercado laboral tras el ciclo. Su currículo básico
se fija en el Anexo V del Real Decreto 659/2023, de 18 de julio, que
desarrolla la ordenación del Sistema de Formación Profesional. En la
Comunidad de Madrid lo desarrolla la Orden 3537/2025, de 12 de agosto,
