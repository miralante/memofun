...
- Concepto general de empresario o empresaria (teoría, no el juego de rol): fpgm_ga_2_empresa-en-el-aula_3.json (alguien que se lanza a una aventura con un plan)
- Plan de empresa simulada: fpgm_ga_2_empresa-en-el-aula_3.json (dibujar el mapa antes de empezar el viaje)
- Denominación social y objeto social: fpgm_ga_2_empresa-en-el-aula_3.json (elegir el nombre de un equipo antes de jugar)
- Funciones y responsabilidades del personal (distinto de "departamentos"): fpgm_ga_2_empresa-en-el-aula_3.json (repartirse los personajes antes de representar una obra)
- Facturación electrónica en la empresa simulada: fpgm_ga_2_empresa-en-el-aula_3.json (mandar el recibo por correo, no a mano)
- Ferias y foros de empresas simuladas: fpgm_ga_2_empresa-en-el-aula_3.json (mercadillo donde cada equipo vende su propio invento)
- Memoria final del proyecto empresarial (el documento, distinto de "cierre"): fpgm_ga_2_empresa-en-el-aula_3.json (álbum de fotos y notas de un gran viaje)
- Presentación pública del proyecto: fpgm_ga_2_empresa-en-el-aula_3.json (subir al escenario a mostrar lo que se ha creado)
