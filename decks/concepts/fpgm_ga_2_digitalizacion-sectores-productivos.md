...
- Ofimática en la nube (Google Workspace, Microsoft 365): fpgm_ga_2_digitalizacion-sectores-productivos_3.json (el cuaderno metido dentro de la nube)
- Wearables: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (un pequeño ordenador en la muñeca)
- Realidad aumentada aplicada al trabajo: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (flechas que explican cómo reparar algo, sobre lo real)
- Asistente virtual: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (alguien que te escucha y ayuda por voz)
- Chatbot: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (hablar por mensajes, pero contesta un programa)
- Phishing: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (un desconocido disfrazado pidiendo las llaves)
- Malware: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (un virus que enferma el ordenador por dentro)
- Contraseña segura: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (cerradura complicada, no un candado simple)
- Verificación en dos pasos: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (dos llaves para abrir la misma puerta)
- Copia de seguridad y recuperación de datos: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (una fotocopia guardada del original)
- Uso responsable de las redes sociales corporativas: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (cuidar lo que dices en una fiesta con gente escuchando)
- Sistemas de pago digitales: fpgm_ga_2_digitalizacion-sectores-productivos_3.json (acercar el móvil y que el pago se haga solo)
- Digitalización en el sector de la gestión administrativa (concepto propio): fpgm_ga_2_digitalizacion-sectores-productivos_3.json (cambiar el archivador de papel por una carpeta digital)
