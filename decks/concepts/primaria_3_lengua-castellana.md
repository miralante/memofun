...
- El artículo (qué es): primaria_3_lengua-castellana_6.json (analogía: gorro que acompaña a la palabra antes de salir a la frase)
- Cómo elegir el/la/los/las: primaria_3_lengua-castellana_6.json (analogía: elegir el zapato del pie correcto)
- Singular (qué es): primaria_3_lengua-castellana_6.json (analogía: señalar una sola manzana en el frutero)
- Plural (qué es, cómo se forma): primaria_3_lengua-castellana_6.json (analogía: señalar todo el frutero lleno)
- El punto (qué es, para qué sirve): primaria_3_lengua-castellana_6.json (analogía: señal de stop)
- La coma (qué es, para qué sirve): primaria_3_lengua-castellana_6.json (analogía: respirar un instante antes de seguir hablando)
- Comprensión lectora de instrucciones y normas: primaria_3_lengua-castellana_6.json (analogía: seguir una receta paso a paso)
- Por qué entender bien una norma antes de seguirla: primaria_3_lengua-castellana_6.json (analogía: reglas de un juego)
- Noticia (qué es): primaria_3_lengua-castellana_6.json (analogía: fotografía escrita de un momento reciente)
- Datos de una noticia (qué, quién, cuándo, dónde): primaria_3_lengua-castellana_6.json (analogía: piezas de un puzle)
- Resumir un texto (qué es): primaria_3_lengua-castellana_6.json (analogía: maleta pequeña con solo lo esencial)
